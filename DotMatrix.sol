...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOT = IBEP20(0xAD29AbB318791D579433D831ed122aFeAf29dcfe);
    ...
    uint256 public minDistribution = 1 * (10**18); // 1 DOT minimum auto send
    uint256 public minimumTokenBalanceForDividends = 20000 * (10**9); // user must hold 2550000 token
...
contract DOTMATRIX is
    BASEToken("Dot-Matrix", "DOTMATRIX", 2000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
